...
import 'package:supa/components/ui/animated_gradient_background.dart';
import 'package:supa/services/widget_service.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocListener(
      listeners: [
        ...
        BlocListener<GarageCubit, GarageState>(
          listener: (context, garageState) {
            if (garageState is VehiclesLoaded) {
              final orderState = context.read<OrderCubit>().state;
              if (orderState is OrdersLoaded) {
                WidgetService.updateFromVehicles(
                  garageState.vehicles,
                  orderState.orders,
                );
              } else {
                WidgetService.updateFromVehicles(garageState.vehicles, []);
              }
            }
          },
        ),
